  ...
  return (
    <div className="relative z-20">
      ...
      <div className="flex items-center gap-1 sm:gap-2">
        <label className="flex items-center gap-1.5 rounded-2xl border border-slate-200 bg-white/80 px-2 py-1.5 text-xs text-slate-700 backdrop-blur cursor-pointer dark:border-white/10 dark:bg-white/5 dark:text-slate-200 sm:gap-2 sm:px-3 sm:py-2 sm:text-sm">
          <input
            type="checkbox"
            checked={voiceOn}
